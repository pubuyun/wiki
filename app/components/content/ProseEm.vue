            ...
            <TooltipPortal>
                ...
                >
                    ...
                    <NuxtLink
                        ...
                        :to="matchedTerm.link"
                        class="mt-2 inline-block font-semibold text-tertiary underline decoration-tertiary/60 decoration-2 underline-offset-4"
                        target="_blank"
                    >
                        Learn more
                    </NuxtLink>
                    <TooltipArrow class="fill-primary-dark" />
                </TooltipContent>
            </TooltipPortal>
        </TooltipRoot>
    </TooltipProvider>
