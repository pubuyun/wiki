...
<template>
    ...
    >
        ...
        >
            <div
                v-if="isLoading"
                class="absolute inset-0 grid place-items-center text-sm text-on-surface"
                role="status"
            >
                Loading graph...
            </div>
