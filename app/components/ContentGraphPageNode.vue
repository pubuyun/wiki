...
<template>
    <div class="nodrag nopan page-node pointer-events-auto relative">
        ...
        <button
            type="button"
            class="page-node__button block w-max min-w-30 origin-center [transform:scale(var(--content-graph-label-scale,1))] cursor-pointer touch-manipulation rounded-[0.875rem] border-2 border-outline bg-primary px-[0.9rem] py-[0.6rem] text-center font-belanosima text-base leading-[1.15] text-on-primary shadow-[0_4px_12px_rgb(0_0_0_/_15%)] transition-[background-color,color,filter] duration-150 will-change-transform hover:bg-secondary hover:text-on-secondary hover:brightness-105 focus-visible:bg-secondary focus-visible:text-on-secondary focus-visible:outline-3 focus-visible:outline-offset-2 focus-visible:outline-outline focus-visible:brightness-105"
