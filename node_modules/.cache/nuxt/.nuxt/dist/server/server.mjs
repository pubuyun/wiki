import { hasInjectionContext, getCurrentInstance, shallowReactive, reactive, effectScope, getCurrentScope, inject, toRef, defineAsyncComponent, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, defineComponent, createElementBlock, provide, cloneVNode, h, computed, toValue, onServerPrefetch, ref, nextTick, unref, shallowReadonly, mergeProps, useSSRContext, Suspense, Fragment, withCtx, createVNode, onErrorCaptured, resolveDynamicComponent, createApp } from "vue";
import { $fetch as $fetch$1 } from "C:/Users/wzh_z/Documents/wiki/node_modules/ofetch/dist/node.mjs";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "C:/Users/wzh_z/Documents/wiki/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "C:/Users/wzh_z/Documents/wiki/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1, appendHeader } from "C:/Users/wzh_z/Documents/wiki/node_modules/@nuxt/nitro-server/dist/runtime/h3-compat.mjs";
import { START_LOCATION, createMemoryHistory, createRouter, useRoute as useRoute$1, RouterView } from "vue-router";
import { defu } from "C:/Users/wzh_z/Documents/wiki/node_modules/defu/dist/defu.mjs";
import { parseURL, encodePath, decodePath, withQuery, hasProtocol, isScriptProtocol, joinURL } from "C:/Users/wzh_z/Documents/wiki/node_modules/ufo/dist/index.mjs";
import { debounce } from "C:/Users/wzh_z/Documents/wiki/node_modules/perfect-debounce/dist/index.mjs";
import { hash } from "C:/Users/wzh_z/Documents/wiki/node_modules/ohash/dist/index.mjs";
...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/testgraph-PhlO25qf.js")
  },
  {
    name: "testviewer",
    path: "/testviewer",
    meta: __nuxt_page_meta$1 || {},
    component: () => import("./_nuxt/testviewer-DtuxP_Oh.js")
  },
  {
    name: "slug",
    path: "/:slug(.*)*",
    component: () => import("./_nuxt/_...slug_-C36b5rf0.js").then((n) => n._)
  },
  {
    name: "index",
    path: "/",
    meta: __nuxt_page_meta || {},
    component: () => import("./_nuxt/index-BAr1pWGQ.js")
  }
];
...
const islandComponents = Object.assign(/* @__PURE__ */ Object.create(null), {
  "VChartIsland": defineAsyncComponent(() => import(
    "./_nuxt/VChartIsland.server-D3fj5n0t.js"
...
const server_plugin_5Y7bHpamez6JeijJx6ikg26pQPdHeZGB2flHSHgp_Lk = /* @__PURE__ */ defineNuxtPlugin(async (_nuxtApp) => {
  let __temp, __restore;
  [__temp, __restore] = executeAsync(() => import("./_nuxt/virtual_nuxt_C__Users_wzh_z_Documents_wiki_node_modules_.cache_nuxt_.nuxt_echarts-BLGRJ1pS.js")), await __temp, __restore();
});
let routes;
...
const plugins = [
  ...
  server_plugin_5Y7bHpamez6JeijJx6ikg26pQPdHeZGB2flHSHgp_Lk,
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      if (unref(isLoading)) {
        _push(`<div${ssrRenderAttrs(mergeProps({ class: "bg-primary-deep fixed inset-0 z-9999 flex items-center justify-center backdrop-blur-sm" }, _attrs))} data-v-9ac87c25><img src="https://static.igem.wiki/teams/6133/wiki/general/loading.webp" alt="Loading" class="h-96" data-v-9ac87c25><span class="sr-only" data-v-9ac87c25>Loading...</span></div>`);
      } else {
        _push(`<!---->`);
      }
    };
...
const __nuxt_component_2 = /* @__PURE__ */ Object.assign(_export_sfc(_sfc_main$3, [["__scopeId", "data-v-9ac87c25"]]), { __name: "Loading" });
const layouts = {
  default: defineAsyncComponent(() => import("./_nuxt/default-BA8Cg0MI.js").then((m) => m.default || m)),
  static: defineAsyncComponent(() => import("./_nuxt/static-CvEAkP6F.js").then((m) => m.default || m))
};
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_NuxtAnnouncer = __nuxt_component_3$1;
      const _component_NuxtRouteAnnouncer = __nuxt_component_3$1;
      const _component_Loading = __nuxt_component_2;
      const _component_NuxtLayout = __nuxt_component_3;
      const _component_NuxtPage = __nuxt_component_4;
      _push(`<!--[-->`);
      _push(ssrRenderComponent(_component_NuxtAnnouncer, null, null, _parent));
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-DVSgOkel.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-CDvyXPxP.js"));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = defineAsyncComponent(() => import("./_nuxt/island-renderer-CtDOtuku.js").then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
    nuxtApp.deferHydration();
...
export {
  ...
  useAsyncData as e,
  __nuxt_component_3$1 as f,
  useRouter as g,
  encodeRoutePath as h,
  islandComponents as i,
  nuxtLinkDefaults as j,
  navigateTo as n,
  pageIslandRoutes as p,
